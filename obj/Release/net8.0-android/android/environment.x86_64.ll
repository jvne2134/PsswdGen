...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100670625, ; uint32_t jnienv_initialize_method_token (0x6001ca1)
	i32 100670624, ; uint32_t jnienv_registerjninatives_method_token (0x6001ca0)
...
@dso_cache = dso_local local_unnamed_addr global [474 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 917031726340689924, ; hash 0xcb9f37f184cd004, from name: libaot-PsswdGn
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PsswdGn.dll.so
		ptr null; void* handle (0x0)
	}, ; 22
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1502071658493416652, ; hash 0x14d86e370fae94cc, from name: PsswdGn.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PsswdGn.dll.so
		ptr null; void* handle (0x0)
	}, ; 35
	...
	%struct.DSOCacheEntry {
		i64 2596495261878406557, ; hash 0x24089aaf113f4d9d, from name: aot-PsswdGn
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PsswdGn.dll.so
		ptr null; void* handle (0x0)
	}, ; 67
	...
	%struct.DSOCacheEntry {
		i64 8958516754654762228, ; hash 0x7c530b862b9514f4, from name: aot-PsswdGn.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PsswdGn.dll.so
		ptr null; void* handle (0x0)
	}, ; 225
	...
	%struct.DSOCacheEntry {
		i64 13527948608663433239, ; hash 0xbbbced95df1fb017, from name: libaot-PsswdGn.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PsswdGn.dll.so
		ptr null; void* handle (0x0)
	}, ; 347
	...
	%struct.DSOCacheEntry {
		i64 17598233961761221753, ; hash 0xf4397c8c7cfe2c79, from name: PsswdGn
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PsswdGn.dll.so
		ptr null; void* handle (0x0)
	}, ; 447
...
@.env.3 = private unnamed_addr constant [37 x i8] c"dee3821b-ac68-4c62-8fac-51645bece1fd\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.psswdgn\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-PsswdGn.dll.so\00", align 16
