...
@dso_cache = dso_local local_unnamed_addr global [474 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 555719158, ; hash 0x211f99f6, from name: aot-PsswdGn
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 955511541, ; hash 0x38f3f2f5, from name: libaot-PsswdGn.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PsswdGn.dll.so
		ptr null; void* handle (0x0)
	}, ; 96
	...
	%struct.DSOCacheEntry {
		i64 1072255391, ; hash 0x3fe9519f, from name: PsswdGn
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PsswdGn.dll.so
		ptr null; void* handle (0x0)
	}, ; 111
	...
	%struct.DSOCacheEntry {
		i64 3589636993, ; hash 0xd5f58381, from name: libaot-PsswdGn
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PsswdGn.dll.so
		ptr null; void* handle (0x0)
	}, ; 399
	...
	%struct.DSOCacheEntry {
		i64 3701582619, ; hash 0xdca1ab1b, from name: PsswdGn.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PsswdGn.dll.so
		ptr null; void* handle (0x0)
	}, ; 411
	...
	%struct.DSOCacheEntry {
		i64 4089172692, ; hash 0xf3bbd2d4, from name: aot-PsswdGn.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PsswdGn.dll.so
		ptr null; void* handle (0x0)
	}, ; 451
